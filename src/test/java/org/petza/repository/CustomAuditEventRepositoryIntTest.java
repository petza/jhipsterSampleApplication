package org.petza.repository;

import org.petza.JhipsterSampleApplicationApp;
import org.petza.config.Constants;
import org.petza.config.audit.AuditEventConverter;
import org.petza.domain.PersistentAuditEvent;
...
import static org.petza.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
